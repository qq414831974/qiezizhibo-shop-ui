...
import departmentChoose from "@/views/my-components/sftg/department-choose";
import departmentTreeChoose from "@/views/my-components/sftg/department-tree-choose";
