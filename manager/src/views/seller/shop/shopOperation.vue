<template>
  <div>
          ...
          <TabPane label="基本信息" class="tab" name="base">
            ...
            <div>
              ...
              <FormItem label="店铺定位" prop="shopCenter">
                <!-- <Input v-model="shopForm.storeCenter" @on-focus="$refs.sftgMap.showMap = true" clearable style="width: 350px" /> -->
                <Button
                  type="info"
                  v-if="!shopForm.storeCenter"
                  @click="$refs.sftgMap.showMap = true"
                >点击获取店铺定位</Button>
                <Button
                  type="success"
                  v-else
    ...
    <sftgMap ref="sftgMap" @getAddress="getAddress"></sftgMap>
...
import uploadPicInput from "@/views/my-components/sftg/upload-pic-input";
import region from "@/views/sftg-components/region";
import sftgMap from "@/views/my-components/map/index";
