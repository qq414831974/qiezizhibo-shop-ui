...
export const otherRouter = {
  ...
  children: [
    ...
    },
    {
      ...
      component: () =>
        import("@/views/promotion/points-goods/points-goods-add.vue")
    },
    {
      ...
      component: () =>
        import("@/views/promotion/points-goods/points-goods-edit.vue")
    },
    {
      ...
      component: () =>
        import("@/views/promotion/points-goods-category/points-goods-category.vue")
    },
    {
      path: "promotions/add-kanJia-activity-goods",
      title: "添加砍价活动",
      name: "add-kanJia-activity-goods",
      component: () => import("@/views/promotion/kanjia/kanjia-activity-add-goods.vue")
    },
    {
      path: "promotions/edit-kanJia-activity-goods",
      title: "修改砍价活动",
      name: "edit-kanJia-activity-goods",
      component: () => import("@/views/promotion/kanjia/kanjia-activity-edit-goods.vue")
    },
    {
    ...
    },
    {
      ...
      title: "编辑模板",
      name: "renovation",
      component: () => import("@/views/sftg-floor-renovation/renovation.vue")
    },
    {
      path: "/floorList/main",
      title: "编辑模板",
      name: "main",
      component: () => import("@/views/sftg-floor-renovation/wap/main.vue")
    },
    {
      path: "add-sms-sign",
      title: "短信签名",
