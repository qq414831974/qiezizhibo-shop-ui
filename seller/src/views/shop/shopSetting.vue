        ...
        <TabPane label="基本信息" name="INFO">
          <Form ref="form" :model="form" :label-width="100" :rules="formValidate">
            ...
            <FormItem label="店铺地址" prop="address">
              <Input v-model="form.address" @on-focus="$refs.sftgMap.showMap = true" clearable style="width: 20%"/>
            </FormItem>
...
import uploadPicThumb from "@/views/my-components/sftg/upload-pic-thumb";
import sftgMap from "@/views/my-components/map/index";
import regionMap from "@/views/sftg-components/region";
